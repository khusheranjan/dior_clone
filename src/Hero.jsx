...
function Hero() {
  return (
    ...
    <div className='mt-6 flex flex-wrap md:flex-nowrap'>
       ...
       <div className='p-4 md:p-0 transition ease-in-out duration-500 hover:scale-110 '>
        <img src="https://www.dior.com/on/demandware.static/-/Library-Sites-DiorSharedLibrary/default/dw0d974c38/images/beauty/08-XMAS23/NAVIGATION/AnyaXmas.jpg" alt="Fragnance" />
